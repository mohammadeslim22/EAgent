...
class Styles {
  ...
  TextStyle smallButton =
      ...
      TextStyle(fontSize: 22, color: colors.black, fontWeight: FontWeight.w100);
  ...
  TextStyle underHeadwhite = const TextStyle(
   ...
   // height: 1.7,
    ...
    color: Colors.grey,
    fontSize: 20,
    decoration: TextDecoration.none,height: 1.7
  );
  ...
  TextStyle paymentCardStyle = const TextStyle(fontSize: 15.0, height: 1.7,fontWeight: FontWeight.w200,);
